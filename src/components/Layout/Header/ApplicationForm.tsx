      ...
      <form>
        ...
        <DialogContent className="sm:max-w-sm gradient-bg border-2 border-white/40 shadow-[0_0_40px_rgba(99,102,241,0.25)]">
          ...
          <FieldGroup>
            ...
            <Field className="group">
              ...
              <Select items={items} required>
                ...
                <SelectContent className="gradient-bg border-2 border-white/50">
                  <SelectGroup>
          ...
          <DialogFooter>
            ...
            <Button type="submit" className="border-2 border-white/20 bg-white/[0.04] backdrop-blur-sm hover:bg-white/15 hover:text-cyan-400/70 hover:border-white/40 transition-colors duration-300 focus-visible:ring-2 focus-visible:ring-cyan-400/70">Save</Button>
          </DialogFooter>
        </DialogContent>
      </form>
    </Dialog>
